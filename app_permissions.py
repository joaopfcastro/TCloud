...
PERMISSION_CATALOG = {
    ...
    "notes.read": {
        ...
        "group": "notes",
        "dangerous": False,
        "description": "Permite listar, abrir e pesquisar notas do TCloud Notes.",
    },
    "notes.write": {
        "label": "Editar notas",
        "group": "notes",
        "dangerous": True,
        "description": "Permite criar, editar e apagar logicamente notas do TCloud Notes.",
    },
    "apps.read": {
        "label": "Ler apps",
        "group": "apps",
...
FUNCTION_CATALOG = {
    ...
    "notes.restoreRevision": {
        "label": "Restaurar revisao de nota",
        "permission": "notes.write",
        "transport": "backend",
        "implemented": True,
        "dangerous": True,
    ...
    "notes.query": {
        "label": "Consultar database de notas",
        "permission": "notes.read",
        "transport": "backend",
        "implemented": True,
        "dangerous": False,
    },
    "notes.properties.getSchema": {
        "label": "Ler schema de propriedades",
        "permission": "notes.read",
        "transport": "backend",
        "implemented": True,
        "dangerous": False,
    },
    "notes.properties.updateSchema": {
        "label": "Atualizar schema de propriedades",
        "permission": "notes.write",
        "transport": "backend",
        "implemented": True,
        "dangerous": True,
    },
    "notes.properties.create": {
        "label": "Criar propriedade de nota",
        "permission": "notes.write",
        "transport": "backend",
        "implemented": True,
        "dangerous": True,
    },
    "notes.properties.update": {
        "label": "Editar propriedade de nota",
        "permission": "notes.write",
        "transport": "backend",
        "implemented": True,
        "dangerous": True,
    },
    "notes.properties.delete": {
        "label": "Remover propriedade do schema",
        "permission": "notes.write",
        "transport": "backend",
        "implemented": True,
        "dangerous": True,
    ...
    "notes.views.delete": {
        "label": "Excluir view de notas",
        "permission": "notes.write",
        "transport": "backend",
        "implemented": True,
        "dangerous": True,
    },
    "notes.views.duplicate": {
        "label": "Duplicar view de notas",
        "permission": "notes.write",
        "transport": "backend",
        "implemented": True,
        "dangerous": True,
    },
    "notes.relations.search": {
        "label": "Buscar notas para relacao",
        "permission": "notes.read",
        "transport": "backend",
        "implemented": True,
        "dangerous": False,
    ...
    "notes.backlinks": {
        "label": "Listar backlinks de nota",
        "permission": "notes.read",
        "transport": "backend",
        "implemented": True,
        "dangerous": False,
