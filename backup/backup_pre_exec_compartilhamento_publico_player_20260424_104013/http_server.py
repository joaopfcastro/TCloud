...
"""
    ...
    async def _handle_api_shared_item_browse(self, request):
        ...
        try:
            ...
            items = await self._file_manager.list_directory(current_path)
            ...
            for item in items:
                ...
                mime_type = item.get("meta", {}).get("mime_type") or mimetypes.guess_type(item.get("name") or "")[0]
                ...
                serialized_items.append({
                    ...
                    "preview_kind": self._guess_public_preview_kind(mime_type, bool(item.get("is_directory"))),
                    "relative_path": item_relative_path,
                    "stream_url": "" if item.get("is_directory") else f"{base_stream}{stream_query}",
                    "download_url": "" if item.get("is_directory") else f"{base_stream}{download_query}",
                })
    ...
    def _build_public_share_summary_payload(self, request, public_id: str, target_kind: str, target_doc: dict) -> dict:
        ...
        mime_type = (target_doc.get("meta") or {}).get("mime_type") or mimetypes.guess_type(target_doc.get("filename") or target_doc.get("path") or "")[0]
        ...
        return {
            ...
            "preview_kind": self._guess_public_preview_kind(mime_type, target_kind == "directory"),
