        ...
        try:
            ...
            for item in items or []:
                ...
                public_items.append({
                    ...
                    "label": item.get("label") or item.get("title") or Path(sidecar_path).name,
                    ...
                    "codec": item.get("codec") or Path(sidecar_path).suffix.lower().lstrip("."),
                    ...
                    "subtitleTimebase": "media_zero",
                    "subtitleSourceMode": "legacy_vtt",
                })
