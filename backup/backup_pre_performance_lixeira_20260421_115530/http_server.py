...
from archive_service import ArchiveCapabilityError, ArchiveService, ArchiveValidationError
...
class TCloudHTTPServer:
    ...
    def _serialize_trash_item(self, item: dict) -> dict:
        ...
        return {
            ...
            "meta": meta,
            "modified_at": _iso_or_none(trashed_at) or "",
    ...
    async def _handle_api_trash(self, request):
        try:
            items = await self._file_manager.list_trash()
